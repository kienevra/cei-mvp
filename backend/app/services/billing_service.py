...
STRIPE_PRICES = {
    # Standalone org
    "standalone_base":     "price_FILL_ME_IN",   # EUR 89/month flat
    "standalone_per_site": "price_FILL_ME_IN",   # EUR 59/site/month
    # Manager / consultant
    "manager_base":        "price_FILL_ME_IN",   # EUR 149/month flat
    "manager_per_site":    "price_FILL_ME_IN",   # EUR 39/site/month
}
